  ...
  topics: [
    {
      ...
      subtopics: [
        {
          number: "1.1",
          title: "The microscrope in cell studies",
          points: [
            {
              number: "1.1.1",
              title:
            ...
            {
              number: "1.1.2",
              title: "draw cells from microscope slides and photomicrographs",
            },
            {
              number: "1.1.3",
              title:
            ...
            {
              number: "1.1.4",
              title: "use an eyepiece graticule and stage micromet",
            },
          ],
        },
        {
          number: "1.2",
          title: "Cells as the basic units of living organisms",
          points: [
            {
              number: "1.2.1",
              title:
            ...
            {
              number: "1.2.3",
              title: "compare the structure of typical plant and animal cells",
            },
            {
              number: "1.2.4",
              title:
    ...
    },
    {
      ...
      subtopics: [
        {
          number: "2.1",
          title: "Testing for biological molecules",
          points: [
            {
              number: "2.1.1",
              title:
    ...
    },
    {
      ...
      subtopics: [
        {
          number: "3.1",
          title: "Mode of action of enzymes",
          points: [
            {
              number: "3.1.1",
              title:
        ...
        {
          number: "3.2",
          title: "Factors that affect enzyme action",
          points: [
            {
              number: "3.2.1",
              title:
    ...
    },
    {
      ...
      subtopics: [
        {
          number: "5.1",
          title: "Replication and division of nuclei and cells",
          points: [
            {
              number: "5.1.1",
              title:
        ...
        {
          number: "5.2",
          title: "Chromosome behaviour in mitosis",
          points: [
            {
              number: "5.2.1",
              title:
    ...
    },
    {
      ...
      subtopics: [
        {
          number: "6.1",
          title: "Structure of nucleic acids and replication of DNA",
          points: [
            {
              number: "6.1.1",
              title:
      ...
      subtopics: [
        {
          ...
          points: [
            ...
            {
              number: "10.1.3",
              title: "explain how cholera, malaria, TB and HIV are transmitted",
            },
            {
              number: "10.1.4",
              title:
    ...
    },
    {
      ...
      subtopics: [
        ...
        {
          number: "11.2",
          title: "Antibodies and vaccination",
          points: [
            {
              number: "11.2.1",
              title:
